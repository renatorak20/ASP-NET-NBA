	...
	public class NBAManagerDbContext: DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
            ...
            modelBuilder.Entity<Team>().HasData(
				new Team { ID = 1, Name = "Atlanta Hawks", VenueID = 1, ConferenceID = 1 },
				new Team { ID = 2, Name = "Boston Celtics", VenueID = 2, ConferenceID = 1 },
				new Team { ID = 3, Name = "Brooklyn Nets", VenueID = 3, ConferenceID = 1 },
				new Team { ID = 4, Name = "Charlotte Hornets", VenueID = 4, ConferenceID = 1 },
				new Team { ID = 5, Name = "Chicago Bulls", VenueID = 5, ConferenceID = 1 },
				new Team { ID = 6, Name = "Cleveland Cavaliers", VenueID = 6, ConferenceID = 1 },
				new Team { ID = 7, Name = "Dallas Mavericks", VenueID = 7, ConferenceID = 2 },
				new Team { ID = 8, Name = "Denver Nuggets", VenueID = 8, ConferenceID = 2 },
				new Team { ID = 9, Name = "Detroit Pistons", VenueID = 9, ConferenceID = 1 },
				new Team { ID = 10, Name = "Golden State Warriors", VenueID = 10, ConferenceID = 2 },
				new Team { ID = 11, Name = "Houston Rockets", VenueID = 11, ConferenceID = 2 },
				new Team { ID = 12, Name = "Indiana Pacers", VenueID = 12, ConferenceID = 1 },
				new Team { ID = 13, Name = "Los Angeles Clippers", VenueID = 13, ConferenceID = 2 },
				new Team { ID = 14, Name = "Los Angeles Lakers", VenueID = 14, ConferenceID = 2 },
				new Team { ID = 15, Name = "Memphis Grizzlies", VenueID = 15, ConferenceID = 2 },
				new Team { ID = 16, Name = "Miami Heat", VenueID = 16, ConferenceID = 1 },
				new Team { ID = 17, Name = "Milwaukee Bucks", VenueID = 17, ConferenceID = 1 },
				new Team { ID = 18, Name = "Minnesota Timberwolves", VenueID = 18, ConferenceID = 2 },
				new Team { ID = 19, Name = "New Orleans Pelicans", VenueID = 19, ConferenceID = 2 },
				new Team { ID = 20, Name = "New York Knicks", VenueID = 20, ConferenceID = 1 },
				new Team { ID = 21, Name = "Oklahoma City Thunder", VenueID = 21, ConferenceID = 2 },
				new Team { ID = 22, Name = "Orlando Magic", VenueID = 22, ConferenceID = 1 },
				new Team { ID = 23, Name = "Philadelphia 76ers", VenueID = 23, ConferenceID = 1 },
				new Team { ID = 24, Name = "Phoenix Suns", VenueID = 24, ConferenceID = 2 },
				new Team { ID = 25, Name = "Portland Trail Blazers", VenueID = 25, ConferenceID = 2 },
				new Team { ID = 26, Name = "Sacramento Kings", VenueID = 26, ConferenceID = 2 },
				new Team { ID = 27, Name = "San Antonio Spurs", VenueID = 27, ConferenceID = 2 },
				new Team { ID = 28, Name = "Toronto Raptors", VenueID = 28, ConferenceID = 1 },
				new Team { ID = 29, Name = "Utah Jazz", VenueID = 29, ConferenceID = 2 },
				new Team { ID = 30, Name = "Washington Wizards", VenueID = 30, ConferenceID = 1 }
			);
